...
noremap ,  :call quickui#menu#open()
noremap ,be :set virtualedit+=all
noremap ,nh :help NERDTree
noremap ,n :NERDTree
...
set ruler
set runtimepath=~/.vim,~/.vim/plugged/vim-boxdraw,~/.vim/plugged/lightline.vim,~/.vim/plugged/vim-windowswap,~/.vim/plugged/vim-quickui,~/.vim/plugged/nerdtree,~/.vim/plugged/vim-project,~/.vim/plugged/papercolor-theme,~/.vim/plugged/everforest,~/.vim/plugged/rigel,~/.vim/plugged/hydrangea-vim,~/.vim/plugged/lucario,~/.vim/plugged/vim,~/.vim/plugged/jellybeans.vim,~/.vim/plugged/awesome-vim-colorschemes,/usr/share/vim/vimfiles,/usr/share/vim/vim90,/usr/share/vim/vimfiles/after,~/.vim/plugged/awesome-vim-colorschemes/after,~/.vim/after
set scrolloff=5
set shiftwidth=4
set showcmd
set showmatch
...
silent! normal! zE
let &fdl = &fdl
let s:l = 155 - ((21 * winheight(0) + 22) / 44)
...
silent! normal! zE
let &fdl = &fdl
let s:l = 166 - ((38 * winheight(0) + 22) / 44)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 166
...
argglobal
1argu
if bufexists(fnamemodify("kfs_super.c", ":p")) | buffer kfs_super.c | else | edit kfs_super.c | endif
balt kfs_super.h
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
silent! normal! zE
let &fdl = &fdl
let s:l = 685 - ((38 * winheight(0) + 22) / 44)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 685
...
argglobal
1argu
if bufexists(fnamemodify("kfs_super.h", ":p")) | buffer kfs_super.h | else | edit kfs_super.h | endif
balt kfs_super.c
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
exe 'vert 2resize ' . ((&columns * 86 + 86) / 172)
argglobal
if bufexists(fnamemodify("kfs_mkfs.c", ":p")) | buffer kfs_mkfs.c | else | edit kfs_mkfs.c | endif
balt mkfs_help.c
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
silent! normal! zE
let &fdl = &fdl
let s:l = 1071 - ((18 * winheight(0) + 22) / 44)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 1071
...
wincmd w
argglobal
if bufexists(fnamemodify("mkfs_help.c", ":p")) | buffer mkfs_help.c | else | edit mkfs_help.c | endif
balt kfs_mkfs.c
setlocal keymap=
setlocal noarabic
setlocal autoindent
