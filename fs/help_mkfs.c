...
char *gennotes[]={
  ...
  "       super inodes and/or slots. The default is about 10%. It needs",
  "       to know the file size -means, to open an existing file or to create",
  "       a new file specifying size with -d-.",
  "",
  "",
  "Author",
